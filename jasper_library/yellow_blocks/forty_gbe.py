...
class forty_gbe(YellowBlock):
    ...
    def instantiate_fgbe(self, top, num=None):
        ...
        if self.port > 1:
            inst.add_port('MEZ3_REFCLK_1_P', 'MEZ3_REFCLK_1_P', parent_port=True, dir='in')
            inst.add_port('MEZ3_REFCLK_1_N', 'MEZ3_REFCLK_1_N', parent_port=True, dir='in')
            inst.add_port('MEZ3_PHY12_LANE_RX_P', 'MEZ3_PHY12_LANE_RX_P', parent_port=True, dir='in', width=4)
            inst.add_port('MEZ3_PHY12_LANE_RX_N', 'MEZ3_PHY12_LANE_RX_N', parent_port=True, dir='in', width=4)
            inst.add_port('MEZ3_PHY12_LANE_TX_P', 'MEZ3_PHY12_LANE_TX_P', parent_port=True, dir='out', width=4)
            inst.add_port('MEZ3_PHY12_LANE_TX_N', 'MEZ3_PHY12_LANE_TX_N', parent_port=True, dir='out', width=4)

        if self.port > 2:
            inst.add_port('MEZ3_REFCLK_2_P', 'MEZ3_REFCLK_2_P', parent_port=True, dir='in')
            inst.add_port('MEZ3_REFCLK_2_N', 'MEZ3_REFCLK_2_N', parent_port=True, dir='in')
            inst.add_port('MEZ3_PHY21_LANE_RX_P', 'MEZ3_PHY21_LANE_RX_P', parent_port=True, dir='in', width=4)
            inst.add_port('MEZ3_PHY21_LANE_RX_N', 'MEZ3_PHY21_LANE_RX_N', parent_port=True, dir='in', width=4)
            inst.add_port('MEZ3_PHY21_LANE_TX_P', 'MEZ3_PHY21_LANE_TX_P', parent_port=True, dir='out', width=4)
            inst.add_port('MEZ3_PHY21_LANE_TX_N', 'MEZ3_PHY21_LANE_TX_N', parent_port=True, dir='out', width=4)

        if self.port > 3:
            inst.add_port('MEZ3_REFCLK_3_P', 'MEZ3_REFCLK_3_P', parent_port=True, dir='in')
            inst.add_port('MEZ3_REFCLK_3_N', 'MEZ3_REFCLK_3_N', parent_port=True, dir='in')
            inst.add_port('MEZ3_PHY22_LANE_RX_P', 'MEZ3_PHY22_LANE_RX_P', parent_port=True, dir='in', width=4)
            inst.add_port('MEZ3_PHY22_LANE_RX_N', 'MEZ3_PHY22_LANE_RX_N', parent_port=True, dir='in', width=4)
            inst.add_port('MEZ3_PHY22_LANE_TX_P', 'MEZ3_PHY22_LANE_TX_P', parent_port=True, dir='out', width=4)
            inst.add_port('MEZ3_PHY22_LANE_TX_N', 'MEZ3_PHY22_LANE_TX_N', parent_port=True, dir='out', width=4)
    ...
    def gen_constraints(self):
        ...
        if self.port > 1:
                ...
                cons.append(PortConstraint('MEZ3_PHY12_LANE_TX_P', 'MEZ3_PHY12_LANE_TX_P', port_index=range(4),  iogroup_index=range(4)))
                cons.append(PortConstraint('MEZ3_PHY12_LANE_TX_N', 'MEZ3_PHY12_LANE_TX_N', port_index=range(4),  iogroup_index=range(4)))
                cons.append(PortConstraint('MEZ3_PHY12_LANE_RX_P', 'MEZ3_PHY12_LANE_RX_P', port_index=range(4),  iogroup_index=range(4)))
                cons.append(PortConstraint('MEZ3_PHY12_LANE_RX_N', 'MEZ3_PHY12_LANE_RX_N', port_index=range(4),  iogroup_index=range(4)))
                cons.append(ClockConstraint('MEZ3_REFCLK_1_P','MEZ3_REFCLK_1_P', period=6.4, port_en=True, virtual_en=False, waveform_min=0.0, waveform_max=3.2))

        if self.port > 2:
                cons.append(PortConstraint('MEZ3_REFCLK_2_P','MEZ3_REFCLK_2_P'))
                cons.append(PortConstraint('MEZ3_REFCLK_2_N','MEZ3_REFCLK_2_N'))
                cons.append(PortConstraint('MEZ3_PHY21_LANE_TX_P', 'MEZ3_PHY21_LANE_TX_P', port_index=range(4),  iogroup_index=range(4)))
                cons.append(PortConstraint('MEZ3_PHY21_LANE_TX_N', 'MEZ3_PHY21_LANE_TX_N', port_index=range(4),  iogroup_index=range(4)))
                cons.append(PortConstraint('MEZ3_PHY21_LANE_RX_P', 'MEZ3_PHY21_LANE_RX_P', port_index=range(4),  iogroup_index=range(4)))
                cons.append(PortConstraint('MEZ3_PHY21_LANE_RX_N', 'MEZ3_PHY21_LANE_RX_N', port_index=range(4),  iogroup_index=range(4)))
                cons.append(ClockConstraint('MEZ3_REFCLK_2_P','MEZ3_REFCLK_2_P', period=6.4, port_en=True, virtual_en=False, waveform_min=0.0, waveform_max=3.2))

        if self.port > 3:
                cons.append(PortConstraint('MEZ3_REFCLK_3_P','MEZ3_REFCLK_3_P'))
                cons.append(PortConstraint('MEZ3_REFCLK_3_N','MEZ3_REFCLK_3_N'))
                cons.append(PortConstraint('MEZ3_PHY22_LANE_TX_P', 'MEZ3_PHY22_LANE_TX_P', port_index=range(4),  iogroup_index=range(4)))
                cons.append(PortConstraint('MEZ3_PHY22_LANE_TX_N', 'MEZ3_PHY22_LANE_TX_N', port_index=range(4),  iogroup_index=range(4)))
                cons.append(PortConstraint('MEZ3_PHY22_LANE_RX_P', 'MEZ3_PHY22_LANE_RX_P', port_index=range(4),  iogroup_index=range(4)))
                cons.append(PortConstraint('MEZ3_PHY22_LANE_RX_N', 'MEZ3_PHY22_LANE_RX_N', port_index=range(4),  iogroup_index=range(4)))
                cons.append(ClockConstraint('MEZ3_REFCLK_3_P','MEZ3_REFCLK_3_P', period=6.4, port_en=True, virtual_en=False, waveform_min=0.0, waveform_max=3.2))
        ...
        if self.port > 0: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT0]'  % self.fullname, 'MEZ3_REFCLK_0_P', 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT0]'  % self.fullname, 'MEZ3_REFCLK_1_P', 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT0]'  % self.fullname, 'MEZ3_REFCLK_2_P', 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT0]'  % self.fullname, 'MEZ3_REFCLK_3_P', 'asynchronous'))
        ...
        if self.port > 0: cons.append(ClockGroupConstraint('MEZ3_REFCLK_0_P', '-of_objects [get_pins %s/gmii_to_sgmii_0/U0/core_clocking_i/mmcm_adv_inst/CLKOUT0]' % self.fullname, 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('MEZ3_REFCLK_1_P', '-of_objects [get_pins %s/gmii_to_sgmii_0/U0/core_clocking_i/mmcm_adv_inst/CLKOUT0]' % self.fullname, 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('MEZ3_REFCLK_2_P', '-of_objects [get_pins %s/gmii_to_sgmii_0/U0/core_clocking_i/mmcm_adv_inst/CLKOUT0]' % self.fullname, 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('MEZ3_REFCLK_3_P', '-of_objects [get_pins %s/gmii_to_sgmii_0/U0/core_clocking_i/mmcm_adv_inst/CLKOUT0]' % self.fullname, 'asynchronous'))
        ...
        if self.port > 0: cons.append(ClockGroupConstraint('VIRTUAL_clkout0', 'MEZ3_REFCLK_0_P', 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('VIRTUAL_clkout0', 'MEZ3_REFCLK_1_P', 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('VIRTUAL_clkout0', 'MEZ3_REFCLK_2_P', 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('VIRTUAL_clkout0', 'MEZ3_REFCLK_3_P', 'asynchronous'))
        if self.port > 0: cons.append(ClockGroupConstraint('MEZ3_REFCLK_0_P', 'FPGA_EMCCLK2', 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('MEZ3_REFCLK_1_P', 'FPGA_EMCCLK2', 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('MEZ3_REFCLK_2_P', 'FPGA_EMCCLK2', 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('MEZ3_REFCLK_3_P', 'FPGA_EMCCLK2', 'asynchronous'))
        if self.port > 0: cons.append(ClockGroupConstraint('FPGA_EMCCLK2', 'MEZ3_REFCLK_0_P', 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('FPGA_EMCCLK2', 'MEZ3_REFCLK_1_P', 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('FPGA_EMCCLK2', 'MEZ3_REFCLK_2_P', 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('FPGA_EMCCLK2', 'MEZ3_REFCLK_3_P', 'asynchronous'))
        ...
        if self.port > 0: cons.append(ClockGroupConstraint('virtual_clock', 'MEZ3_REFCLK_0_P', 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('virtual_clock', 'MEZ3_REFCLK_1_P', 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('virtual_clock', 'MEZ3_REFCLK_2_P', 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('virtual_clock', 'MEZ3_REFCLK_3_P', 'asynchronous'))
        ...
        if self.port > 0: cons.append(ClockGroupConstraint('MEZ3_REFCLK_0_P', 'virtual_clock', 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('MEZ3_REFCLK_1_P', 'virtual_clock', 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('MEZ3_REFCLK_2_P', 'virtual_clock', 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('MEZ3_REFCLK_3_P', 'virtual_clock', 'asynchronous'))
        ...
        if self.port > 0: cons.append(ClockGroupConstraint('VIRTUAL_I', 'MEZ3_REFCLK_0_P', 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('VIRTUAL_I', 'MEZ3_REFCLK_1_P', 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('VIRTUAL_I', 'MEZ3_REFCLK_2_P', 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('VIRTUAL_I', 'MEZ3_REFCLK_3_P', 'asynchronous'))
        if self.port > 0: cons.append(ClockGroupConstraint('MEZ3_REFCLK_0_P', 'VIRTUAL_I','asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('MEZ3_REFCLK_1_P', 'VIRTUAL_I','asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('MEZ3_REFCLK_2_P', 'VIRTUAL_I','asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('MEZ3_REFCLK_3_P', 'VIRTUAL_I','asynchronous'))
        ...
        if self.port > 0: cons.append(ClockGroupConstraint('MEZ3_REFCLK_0_P', '-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT1]' % self.fullname, 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('MEZ3_REFCLK_1_P', '-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT1]' % self.fullname, 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('MEZ3_REFCLK_2_P', '-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT1]' % self.fullname, 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('MEZ3_REFCLK_3_P', '-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT1]' % self.fullname, 'asynchronous'))
        if self.port > 0: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT1]' % self.fullname, 'MEZ3_REFCLK_0_P', 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT1]' % self.fullname, 'MEZ3_REFCLK_1_P', 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT1]' % self.fullname, 'MEZ3_REFCLK_2_P', 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT1]' % self.fullname, 'MEZ3_REFCLK_3_P', 'asynchronous'))
        ...
        if self.port > 0: cons.append(ClockGroupConstraint('MEZ3_REFCLK_0_P', '-of_objects [get_pins %s/USER_CLK_MMCM_inst/CLKOUT0]' % self.fullname, 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('MEZ3_REFCLK_1_P', '-of_objects [get_pins %s/USER_CLK_MMCM_inst/CLKOUT0]' % self.fullname, 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('MEZ3_REFCLK_2_P', '-of_objects [get_pins %s/USER_CLK_MMCM_inst/CLKOUT0]' % self.fullname, 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('MEZ3_REFCLK_3_P', '-of_objects [get_pins %s/USER_CLK_MMCM_inst/CLKOUT0]' % self.fullname, 'asynchronous'))
        if self.port > 0: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/USER_CLK_MMCM_inst/CLKOUT0]' % self.fullname, 'MEZ3_REFCLK_0_P', 'asynchronous'))
        if self.port > 1: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/USER_CLK_MMCM_inst/CLKOUT0]' % self.fullname, 'MEZ3_REFCLK_1_P', 'asynchronous'))
        if self.port > 2: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/USER_CLK_MMCM_inst/CLKOUT0]' % self.fullname, 'MEZ3_REFCLK_2_P', 'asynchronous'))
        if self.port > 3: cons.append(ClockGroupConstraint('-of_objects [get_pins %s/USER_CLK_MMCM_inst/CLKOUT0]' % self.fullname, 'MEZ3_REFCLK_3_P', 'asynchronous'))
        ...
        if self.port > 0: cons.append(InputDelayConstraint(clkname='MEZ3_REFCLK_0_P', consttype='min', constdelay_ns=1.0, add_delay_en=True, portname='FPGA_RESET_N'))
        if self.port > 0: cons.append(InputDelayConstraint(clkname='MEZ3_REFCLK_0_P', consttype='max', constdelay_ns=2.0, add_delay_en=True, portname='FPGA_RESET_N'))
        if self.port > 1: cons.append(InputDelayConstraint(clkname='MEZ3_REFCLK_1_P', consttype='min', constdelay_ns=1.0, add_delay_en=True, portname='FPGA_RESET_N'))
        if self.port > 1: cons.append(InputDelayConstraint(clkname='MEZ3_REFCLK_1_P', consttype='max', constdelay_ns=2.0, add_delay_en=True, portname='FPGA_RESET_N'))
        if self.port > 2: cons.append(InputDelayConstraint(clkname='MEZ3_REFCLK_2_P', consttype='min', constdelay_ns=1.0, add_delay_en=True, portname='FPGA_RESET_N'))
        if self.port > 2: cons.append(InputDelayConstraint(clkname='MEZ3_REFCLK_2_P', consttype='max', constdelay_ns=2.0, add_delay_en=True, portname='FPGA_RESET_N'))
        if self.port > 3: cons.append(InputDelayConstraint(clkname='MEZ3_REFCLK_3_P', consttype='min', constdelay_ns=1.0, add_delay_en=True, portname='FPGA_RESET_N'))
        if self.port > 3: cons.append(InputDelayConstraint(clkname='MEZ3_REFCLK_3_P', consttype='max', constdelay_ns=2.0, add_delay_en=True, portname='FPGA_RESET_N'))
        ...
        if self.port > 0: cons.append(MultiCycleConstraint(multicycletype='setup',sourcepath='get_ports FPGA_RESET_N', destpath='get_clocks MEZ3_REFCLK_0_P', multicycledelay=4))
        if self.port > 0: cons.append(MultiCycleConstraint(multicycletype='hold',sourcepath='get_ports FPGA_RESET_N', destpath='get_clocks MEZ3_REFCLK_0_P', multicycledelay=4))
        if self.port > 1: cons.append(MultiCycleConstraint(multicycletype='setup',sourcepath='get_ports FPGA_RESET_N', destpath='get_clocks MEZ3_REFCLK_1_P', multicycledelay=4))
        if self.port > 1: cons.append(MultiCycleConstraint(multicycletype='hold',sourcepath='get_ports FPGA_RESET_N', destpath='get_clocks MEZ3_REFCLK_1_P', multicycledelay=4))
        if self.port > 2: cons.append(MultiCycleConstraint(multicycletype='setup',sourcepath='get_ports FPGA_RESET_N', destpath='get_clocks MEZ3_REFCLK_2_P', multicycledelay=4))
        if self.port > 2: cons.append(MultiCycleConstraint(multicycletype='hold',sourcepath='get_ports FPGA_RESET_N', destpath='get_clocks MEZ3_REFCLK_2_P', multicycledelay=4))
        if self.port > 3: cons.append(MultiCycleConstraint(multicycletype='setup',sourcepath='get_ports FPGA_RESET_N', destpath='get_clocks MEZ3_REFCLK_3_P', multicycledelay=4))
        if self.port > 3: cons.append(MultiCycleConstraint(multicycletype='hold',sourcepath='get_ports FPGA_RESET_N', destpath='get_clocks MEZ3_REFCLK_3_P', multicycledelay=4))
        ...
        if self.port > 1:
            cons.append(RawConstraint('create_pblock MEZ3_PHY12_QSFP'))
            cons.append(RawConstraint('add_cells_to_pblock [get_pblocks MEZ3_PHY12_QSFP] [get_cells -quiet [list '+self.fullname+'/generate_forty_gbe_phy_port1.IEEE802_3_XL_PHY_1/PHY_inst/RX_CLK_RCC]]'))
            cons.append(RawConstraint('add_cells_to_pblock [get_pblocks MEZ3_PHY12_QSFP] [get_cells -quiet [list '+self.fullname+'/generate_forty_gbe_phy_port1.IEEE802_3_XL_PHY_1/PHY_inst/TX_CLK_RCC]]'))
            cons.append(RawConstraint('resize_pblock [get_pblocks MEZ3_PHY12_QSFP] -add {CLOCKREGION_X1Y6:CLOCKREGION_X1Y6}'))

        if self.port > 2:
            cons.append(RawConstraint('create_pblock MEZ3_PHY21_QSFP'))
            cons.append(RawConstraint('add_cells_to_pblock [get_pblocks MEZ3_PHY21_QSFP] [get_cells -quiet [list '+self.fullname+'/generate_forty_gbe_phy_port2.IEEE802_3_XL_PHY_1/PHY_inst/RX_CLK_RCC]]'))
            cons.append(RawConstraint('add_cells_to_pblock [get_pblocks MEZ3_PHY21_QSFP] [get_cells -quiet [list '+self.fullname+'/generate_forty_gbe_phy_port2.IEEE802_3_XL_PHY_1/PHY_inst/TX_CLK_RCC]]'))
            cons.append(RawConstraint('resize_pblock [get_pblocks MEZ3_PHY21_QSFP] -add {CLOCKREGION_X1Y5:CLOCKREGION_X1Y5}'))

        if self.port > 3:
            cons.append(RawConstraint('create_pblock MEZ3_PHY22_QSFP'))
            cons.append(RawConstraint('add_cells_to_pblock [get_pblocks MEZ3_PHY22_QSFP] [get_cells -quiet [list '+self.fullname+'/generate_forty_gbe_phy_port3.IEEE802_3_XL_PHY_1/PHY_inst/RX_CLK_RCC]]'))
            cons.append(RawConstraint('add_cells_to_pblock [get_pblocks MEZ3_PHY22_QSFP] [get_cells -quiet [list '+self.fullname+'/generate_forty_gbe_phy_port3.IEEE802_3_XL_PHY_1/PHY_inst/TX_CLK_RCC]]'))
            cons.append(RawConstraint('resize_pblock [get_pblocks MEZ3_PHY22_QSFP] -add {CLOCKREGION_X1Y4:CLOCKREGION_X1Y4}'))
